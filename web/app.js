...
function sendConfig(event) {
  ...
  const payload = {
    ...
    max_incomplete_segment_seconds: serviceMode === "accurate" ? 12.0 : 10.0,
    sentence_completion_min_seconds: serviceMode === "accurate" ? 4.0 : 0.0,
    max_pending_audio_seconds: serviceMode === "accurate" ? 18.0 : 8.0,
