...
class TestClientCallbacks(BaseTestCase):
    def test_on_open(self):
        ...
        self.assertEqual(sent_message["target_language"], "auto")
        self.assertEqual(sent_message["translation_provider"], "helsinki_zh_en")
        self.assertEqual(sent_message["zh_en_model_path"], "model/opus-mt-zh-en")
        self.assertEqual(sent_message["en_zh_model_path"], "model/opus-mt-en-zh")
