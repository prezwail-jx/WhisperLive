# Hotword Conditioning Specification

## Purpose

Define safe ASR hotword conditioning behavior, including source precedence, glossary isolation, backend consistency, hallucination suppression, and operational observability.
